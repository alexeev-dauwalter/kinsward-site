...
Kinsward is in active pre-1.0 development (v0.33.0). Core systems — adventure mode, overseer mode, procedural world generation, unit commands, crafting, the kinswardctl debug tool, CLI subcommands (`new`, `load`), game phase management, a dark-themed UI with sprite icons and floating panels, 2D bloom, and experimental WASM web support — are functional. Advanced AI and textured rendering are planned for future phases.
