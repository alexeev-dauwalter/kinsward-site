...
Kinsward is in active pre-1.0 development (v0.35.0). Core systems — adventure mode, overseer mode, procedural world generation, unit commands, crafting, stockpile zones, containers, hauling, save/load, and the kinswardctl debug tool — are functional. Advanced colony AI, a cohesive production loop, and original textured rendering are planned for future phases.
