...
For large-scale operations, use [kinswardctl zone commands](/gamectl/commands/#zone-operations) to issue bulk build/demolish orders across rectangular areas.
